...
func init() {
	slip.Define(
		func(args slip.List) slip.Object {
			f := HashTableSize{Function: slip.Function{Name: "hash-table-size", Args: args}}
			f.Self = &f
			return &f
		},
		&slip.FuncDoc{
			...
			Args: []*slip.DocArg{
				{
					Name: "hash-table",
					Type: "hash-table",
					Text: "The _hash-table_ to return the size of.",
				},
			},
			Return: "fixnum",
			Text: `__hash-table-size__ returns size of the _hash-table_ which is the number of entries
in the _hash-table_.`,
			Examples: []string{
