...
func init() {
	slip.Define(
		func(args slip.List) slip.Object {
			f := BitOrc1{Function: slip.Function{Name: "bit-orc1", Args: args}}
			f.Self = &f
			return &f
		},
		&slip.FuncDoc{
			...
			Return: "bit-array",
			Text: `__bit-orc1__ returns an array with the same dimension as both _bit-array1_ or
_bit-array2_ that is a logical OR of the complement of _bit-array1_ and _bit-array2_. If _opt-arg_
is provided it is used as the result array.`,
			Examples: []string{
				"(bit-orc1 #*1010 #*1100) => #*1101",
			},
		}, &slip.CLPkg)
}
