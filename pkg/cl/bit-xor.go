...
func init() {
	slip.Define(
		func(args slip.List) slip.Object {
			f := BitXor{Function: slip.Function{Name: "bit-xor", Args: args}}
			f.Self = &f
			return &f
		},
		&slip.FuncDoc{
			...
			Return: "bit-array",
			Text: `__bit-xor__ returns an array with the same dimension as both _bit-array1_ or
_bit-array2_ that is a logical XOR of _bit-array1_ and _bit-array2_. If _opt-arg_
is provided it is used as the result array.`,
			Examples: []string{
				"(bit-xor #*1010 #*1100) => #*0110",
			},
		}, &slip.CLPkg)
}
