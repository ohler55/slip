...
func TestTraceOk(t *testing.T) {
	...
	slip.Trace(true)
	_ = slip.ReadString("(car (car (car '(((a))))))").Eval(slip.NewScope())
	slip.Trace(false)
...
func TestTracePanicANSI(t *testing.T) {
	...
	slip.Trace(true)
	tt.Panic(t, func() { _ = slip.ReadString("(car (car (car 7)))").Eval(slip.NewScope()) })
	slip.Trace(false)
...
func TestTracePanicDeep(t *testing.T) {
	...
	tt.Panic(t, func() { _ = slip.Read(deep).Eval(slip.NewScope()) })
	slip.Trace(false)
