...
func TestBitAndc1VectorOk(t *testing.T) {
	(&sliptest.Function{
		Source: "(bit-andc1 #*1010 #*1100)",
		Expect: "#*0100",
	}).Test(t)
}

func TestBitAndc1VectorOptArg(t *testing.T) {
	(&sliptest.Function{
		Source: "(bit-andc1 #*1010 #*1100 #*0000)",
		Expect: "#*0100",
	}).Test(t)
}

func TestBitAndc1ArrayOk(t *testing.T) {
	(&sliptest.Function{
		Source: `(bit-andc1
