...
func TestRandomFixnum(t *testing.T) {
	scope := slip.NewScope()
	result := slip.CompileString("(random 10)").Eval(scope, 0)
	tt.SameType(t, slip.Fixnum(0), result)
	num := int(result.(slip.Fixnum))
	tt.Equal(t, true, 0 <= num)
	tt.Equal(t, true, num < 10)

	result = slip.CompileString("(random 10 *random-state*)").Eval(scope, 0)
	tt.SameType(t, slip.Fixnum(0), result)
	num = int(result.(slip.Fixnum))
	tt.Equal(t, true, 0 <= num)
	tt.Equal(t, true, num < 10)

	result = slip.CompileString("(random 10 nil)").Eval(scope, 0)
	tt.SameType(t, slip.Fixnum(0), result)
	num = int(result.(slip.Fixnum))
	tt.Equal(t, true, 0 <= num)
	tt.Equal(t, true, num < 10)

	result = slip.CompileString("(random 10 t)").Eval(scope, 0)
	tt.SameType(t, slip.Fixnum(0), result)
	num = int(result.(slip.Fixnum))
	tt.Equal(t, true, 0 <= num)
	tt.Equal(t, true, num < 10)
...
func TestRandomSingleFloat(t *testing.T) {
	scope := slip.NewScope()
	result := slip.CompileString("(random 10s+0)").Eval(scope, 0)
	...
	result = slip.CompileString("(random 10s+0 *random-state*)").Eval(scope, 0)
	tt.SameType(t, slip.SingleFloat(0.0), result)
	num = float64(result.(slip.SingleFloat))
	tt.Equal(t, true, 0.0 <= num)
	tt.Equal(t, true, num < 10.0)
...
func TestRandomDoubleFloat(t *testing.T) {
	scope := slip.NewScope()
	result := slip.CompileString("(random 10d+0)").Eval(scope, 0)
	tt.SameType(t, slip.DoubleFloat(0.0), result)
	num := float64(result.(slip.DoubleFloat))
	tt.Equal(t, true, 0.0 <= num)
	tt.Equal(t, true, num < 10.0)

	result = slip.CompileString("(random 10d+0 *random-state*)").Eval(scope, 0)
	tt.SameType(t, slip.DoubleFloat(0.0), result)
	num = float64(result.(slip.DoubleFloat))
	tt.Equal(t, true, 0.0 <= num)
	tt.Equal(t, true, num < 10.0)
...
func TestRandomLongFloat(t *testing.T) {
	scope := slip.NewScope()
	result := slip.CompileString("(random 10L+0)").Eval(scope, 0)
...
func TestRandomBignum(t *testing.T) {
	scope := slip.NewScope()
	result := slip.CompileString("(random (- 10000000000000000010 10000000000000000000))").Eval(scope, 0)
