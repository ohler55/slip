...
func init() {
	DefConstant(&CLPkg, string(ShortFloatSymbol), ShortFloatSymbol,
...
digits and a maximum exponent of 38.`)
	DefConstant(&CLPkg, "most-positive-short-float", ShortFloat(math.MaxFloat32),
		"The most positive value a _short-float_ can have.")
	DefConstant(&CLPkg, "most-negative-short-float", ShortFloat(-math.MaxFloat32),
		"The most negative value a _short-float_ can have.")
	DefConstant(&CLPkg, "least-positive-short-float", ShortFloat(math.SmallestNonzeroFloat32),
		"The smallest non-zero positive value a _short-float_ can have.")
	DefConstant(&CLPkg, "least-negative-short-float", ShortFloat(-math.SmallestNonzeroFloat32),
		"The smallest non-zero negative value a _short-float_ can have.")
	DefConstant(&CLPkg, "least-positive-normalized-short-float", ShortFloat(math.SmallestNonzeroFloat32),
		"The smallest non-zero positive value a _short-float_ can have.")
	DefConstant(&CLPkg, "least-negative-normalized-short-float", ShortFloat(-math.SmallestNonzeroFloat32),
		"The smallest non-zero negative value a _short-float_ can have.")
	DefConstant(&CLPkg, "short-float-epsilon", ShortFloat(5.960465e-8),
		`The smallest positive _short-float_ such the addition of the epsilon value to
1.0s0 returns a value greater than 1.0s0.`)
	DefConstant(&CLPkg, "short-float-negative-epsilon", ShortFloat(5.960465e-8),
